...
export function registerTools(server) {
    ...
    server.tool("get-historical-data", "Fetch historical OHLC data", {
        symbol: z.string(),
        startDate: z.string(),
        endDate: z.string(),
    ...
    /* ───── Stock: news ──────────────────────────────────────────────────── */
    server.tool("get-news", "Get news articles for a company/stock", {
        stockName: z.string(),
        startDate: z.string(),
        endDate: z.string(),
    ...
    server.tool("get-technical-indicators", "Calculate a single technical indicator", {
        symbol: z.string(),
    ...
    server.tool("get-technical-analysis", "Full multi‑indicator technical analysis", {
        symbol: z.string(),
        startDate: z.string(),
        endDate: z.string(),
...
function indicatorSwitch(indicator, closes, dates, period, symbol) {
